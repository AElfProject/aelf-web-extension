...
apis.windows.onRemoved.addListener((number) => {
...
export default class NotificationService {
  ...
  static async open(notification) {
    ...
    const height = 600;
    // let method = notification.message.payload.payload ?
    // notification.message.payload.payload.method : notification.message.payload.method;
